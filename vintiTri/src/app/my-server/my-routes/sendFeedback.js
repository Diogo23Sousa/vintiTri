...
module.exports = function(app) {
        ...
        let transporter = nodemailer.createTransport({
          ...
          auth: {
            ...
            let mailOptions = {
              ...
              We would like to thank you for your feedback message: <br>
    ...
    let mailOptions2 = {
      ...
      The following user: ` + req.body.name +  `, with the email: ` + req.body.email + `, sent you this feedback message: <br>
      '' ` + req.body.message + ` '' <br> <br>
      Best Regards, <br>
      Vinti-Tri Team
      </div>
